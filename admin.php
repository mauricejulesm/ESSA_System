...
if(!empty($_SESSION['LoggedIn']) && !empty($_SESSION['username'])){
  ...
  $subj_counter = "SELECT * from subjects";
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><span>ESSA DB</span></a>
            </div>
            ...
            <div class="row top_tiles">
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  ...
                  <div class="count"><?php echo $subjcount?></div>
                  <h3>Subjects</h3>
              ...
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  ...
                  <div class="count"><?php echo $ssum?></div>
                  <h3>Snippets</h3>
                  <p>From all subjects.</p>
                </div>
              </div>
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
        ...
        <footer>
          <div class="pull-right">
            Mtabe App, a <a href="http://myelimu.com">MyElimu</a> product.
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
...
//check that there is nothing wrong with the query
    ...
    {
      //Show an error message that their account could not be forund
      mysqli_error($conn);
        echo "<h1>Error</h1>";
        echo "<p>Sorry, your account could not be found. Please <a href=\"admin.php\">click here to try again</a>.</p>";
    }
}
    ...
    <div>
      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
              <h1>Welcome to ESSA<br><br> Database</h1>
              <div>
        ...
        !-->
                ...
                <div>
                  <h1><i class="fa fa-copyright"></i> ESSA Project</h1>
