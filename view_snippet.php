...
?>
    <title>Snippet Information</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"></i> <span>Mtabe Admin</span></a>
            </div>
...
$fetch = "SELECT * from $subject_database WHERE code = '$scode'";
...
while ($row = mysql_fetch_assoc($fetch_query)){
...
?>
                        ...
                        <tr>
                          <th>Impacts</th>
                          <td><?php echo $impacts ?></td>
                        </tr>

                        
                        <tr>
                          <th>Characteristics</th>
                          <td><?php echo $characteristics ?></td>
                        </tr>

                        
                        <tr>
                          <th>Examples</th>
                          <td><?php echo $examples ?></td>
                        </tr>
                        ...
                        <tr>
                          <th>Advantages</th>
                          <td><?php echo $advantages ?></td>
                        </tr>

                        
                        <tr>
                          <th>Disadvatages</th>
                          <td><?php echo $disadvantages ?></td>
                        </tr>
