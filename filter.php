...
function showSnippet(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","get_country.php?&code="+str,true);
        xmlhttp.send();
    }
}
</script>
...
function showdata(str, x) {
    if (str == "") {
        ...
        xmlhttp.open("GET","get_data.php?&code2="+str+"&region="+x,true);
        xmlhttp.send();
    }
}
</script>
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                   <a type="button" class="btn btn-primary" href = "cluster2.php">Browse Universites</a><a type="button" class="btn btn-danger" href = "filter.php">Filter Universities</a><a type="button" class="btn btn-info" href = "visualize_uni.php">Visualize Universities</a>
                    <!-- download button -->
                    <ul class="nav navbar-right panel_toolbox">
                      <a type="button" class="btn btn-success" href = "Bschool.xlsx" target="blank"><i class="fa fa-download" aria-hidden="true"></i> Download Data</a>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
...
<div class="form-group">
 ...
 /*
                            $clist = "SELECT * from universities";
                            $clistr = mysqli_query($conn, $clist);

                            while ($clisrow = $clistr->fetch_assoc()){
                              $region = $clisrow['region'];
                              $code = $clisrow['code'];
                              $cregion = $clisrow['region'];
                              ?>
