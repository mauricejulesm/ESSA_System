...
echo "<meta http-equiv='refresh' content=0.5;..php />";
...
function showSnippet(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","get_scholarship.php?&code="+str,true);
        xmlhttp.send();
    }
}
</script>
...
function showUni(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","scholarship_details.php?&code="+str,true);
        xmlhttp.send();
    }
}
</script>
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                   <a type="button" class="btn btn-primary" href = "cluster3.php">Browse Scholarship</a><a type="button" class="btn btn-danger" href = "filter_scholarships.php">Filter Scholarships</a>
...
<div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          <option value="" placeholder = "Chagua">...</option>
                            ...
                            $clist = "SELECT DISTINCT SSA_or_NonSSA from scholarships_mapping";
                            $clistr = mysqli_query($conn, $clist);

                            while ($clisrow = $clistr->fetch_assoc()){
                              $country = $clisrow['SSA_or_NonSSA'];
                              ?>
