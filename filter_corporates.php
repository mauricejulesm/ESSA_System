...
?>
    <title>Corporates Mapping</title>
...
function showSnippet(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","get_country_of_origin.php?&code="+str,true);
        xmlhttp.send();
    }
}
</script>
...
function showdata(str, x) {
    if (str == "") {
        ...
        xmlhttp.open("GET","get_data_corporates.php?&code2="+str+"&Region="+x,true);
        xmlhttp.send();
    }
}
</script>
                  ...
                  <div class="x_title">
                   ...
                   <a type="button" class="btn btn-danger" href = "filter_corporates.php">Filter Corporates</a>
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <a type="button" class="btn btn-success" href = "ESSA Cluster 1 Corporate Mapping  Multinationals Final.xlsx" target="blank"><i class="fa fa-download" aria-hidden="true"></i> Download Data</a>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
...
<div class="form-group">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Corporate Region:</label>
