...
function showSnippet(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","get_uni.php?&code="+str,true);
        xmlhttp.send();
    }
}
</script>
...
function showUni(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","uni_details.php?&code="+str,true);
        xmlhttp.send();
    }
}
</script>
                  ...
                  <div class="x_title">
                   <a type="button" class="btn btn-primary" href = "cluster2.php">Browse Universites</a><a type="button" class="btn btn-danger" href = "filter.php">Filter Universities</a><a type="button" class="btn btn-info" href = "visualize_uni.php">Visualize Universities</a>
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <a type="button" class="btn btn-success" href = "Cluster2B-School.xlsx" target="blank"><i class="fa fa-download" aria-hidden="true"></i> Download Data</a>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
...
<div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          <option value="" placeholder = "Chagua">...</option>
                            ...
                            $clist = "SELECT DISTINCT country from universities";
